...
public final class Orange extends JuiceEntity implements Squeezable {
    private static final double JUICE_AMOUNT_PER_KG = 0.6d; //l

    public Orange(String name, LocalDateTime createDateTime, Item[] items, BigDecimal weight) {
